...
export function Login() {
  ...
  useEffect(() => {
    document.title = 'Đăng nhập | ThreadsCity';
  }, []);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // navigate is handled in the useEffect above
    } catch (err: any) {
      const errorMessage = err.message || 'Đăng nhập thất bại. Vui lòng kiểm tra thông tin đăng nhập.';
  ...
  return (
    <div className="auth-page">
      ...
      <div className="auth-container">
        <h1 className="auth-title">Đăng nhập vào ThreadsCity</h1>
