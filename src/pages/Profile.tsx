...
export function Profile() {
  ...
  useEffect(() => {
    // Đặt tiêu đề trang
    document.title = "Trang cá nhân | ThreadsCity";
      ...
      <div className="feed-header-wrapper">
        <div className="post-detail-header search-detail-header">
          ...
          <button className="post-detail-options">
            <svg viewBox="0 0 24 24" aria-hidden="true">
              <path d="M3 12c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2zm9 2c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm7 0c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 2 2 2 2z"></path>
            </svg>
          </button>
        </div>
      </div>
