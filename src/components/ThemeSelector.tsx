...
interface ThemeSelectorProps {
  isOpen: boolean;
  onClose: () => void;
  onBack: () => void; // Thêm hàm callback quay lại
}

export function ThemeSelector({ isOpen, onClose, onBack }: ThemeSelectorProps) {
  ...
  return (
    <div className={`theme-selector ${isOpen ? 'active' : ''}`} ref={selectorRef}>
